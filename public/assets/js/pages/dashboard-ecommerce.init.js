...
var linechartcustomerColors = getChartColorsArray("study_opportunity_charts");
...
if (linechartcustomerColors) {
  ...
  var chart = new ApexCharts(document.querySelector("#study_opportunity_charts"), options);
  chart.render();
} // Multi-Radial Bar


var chartRadialbarMultipleColors = getChartColorsArray("profitability_radialbar");
...
if (chartRadialbarMultipleColors) {
  ...
  var chart = new ApexCharts(document.querySelector("#profitability_radialbar"), options);
  chart.render();
} // Simple Donut Charts
